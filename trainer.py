...
def load_and_map_dataset_kpwr(dataset_name: str = "clarin-pl/kpwr-ner"):
    ...
    def convert_label(label):
        ...
        mapped_category = category_mapping.get(base_label, 'O')
...
def TrainModel(path: str, language: str = "EN"):
    ...
    datasets = load_dataset("conll2003") if language == "EN" else load_and_map_dataset_kpwr()
